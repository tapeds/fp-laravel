                    ...
                    <div class="space-y-6">
                        ...
                        @else
                            @foreach ($daftar_penerbangan as $penerbangan)
                                ...
                                <x-penerbangan.card href="{{ route('pesanan', ['id' => $penerbangan->id]) }}"
                                    :jadwalKedatangan="$penerbangan->jadwal_kedatangan" :harga="$penerbangan->harga" :kapasitas="$penerbangan->kapasitas" :jadwalBerangkat="$penerbangan->jadwal_berangkat"
