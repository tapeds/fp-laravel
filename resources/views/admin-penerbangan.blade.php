<x-app-layout>
    <h1 class="text-xl font-semibold">Dashboard Admin Penerbangan</h1>
    <section class="mt-5">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-3">No Penerbangan</th>
                                <th scope="col" class="px-4 py-3">Jadwal Berangkat</th>
                                <th scope="col" class="px-4 py-3">Jadwal Kedatangan</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $penerbangan->no_penerbangan }}</th>
                                <td class="px-4 py-3">{{ $penerbangan->jadwal_berangkat }}</td>
                                <td class="px-4 py-3">{{ $penerbangan->jadwal_kedatangan }}</td>
                                <td class="px-4 py-3">{{ 'Rp ' . number_format($penerbangan->harga, 0, ',', '.') }}</td>
                                <td class="px-4 py-3">{{ $penerbangan->kapasitas }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="penerbangan-{{ $penerbangan->id }}-dropdown-button" data-dropdown-toggle="penerbangan-{{ $penerbangan->id }}-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="penerbangan-{{ $penerbangan->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="penerbangan-{{ $penerbangan->id }}-dropdown-button">
                                            <li>
