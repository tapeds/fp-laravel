        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                {{-- <div class="flex-shrink-0">
                    <img class="h-8 w-11"
                        src="https://www.its.ac.id/wp-content/uploads/2019/02/Logo-its-biru-transparan.png"
                        alt="Your Company">
                </div> --}}
            ...
            <div class="hidden md:block">
                            ...
                            <div>
                                <button type="button" @click="isOpen = !isOpen"
                                    ...
                                    <img class="h-8 w-8 object-cover rounded-full"
                                        src="https://i.pinimg.com/736x/99/80/ea/9980eaf82af7e3cdf228039efc3491da.jpg"
                                        alt="profile img">
                                </button>
                            </div>
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold text-gray-300 hover:text-gray-500 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in</a>

                    <a href="{{ route('register') }}"
                        class="ml-4 font-semibold text-gray-300 hover:text-gray-500 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                @endif
